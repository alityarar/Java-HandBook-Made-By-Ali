...
public class C04_Scanner {
    public static void main(String[] args) {
        ...
        Scanner scan = new Scanner(System.in);  //esitligin saginda yeni bir scanner olusturulur ve olusturulan bu
                                                 //scanner scan variable na assing edilir
        ...
        String kullaniciIsmi= scan.next(); //Sadece ilk kelimeyi alir (Ilk Space e kadar alir)

        //Butun satiri almak icin    nextLine()    kullanilir
